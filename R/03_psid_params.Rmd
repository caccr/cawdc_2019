...
l7 <- " other chemicals were tested for and NOT detected, thus these chemicals are not included in the chart above."
...
if(length(vio) == 1){ 
  if(vio == "IN COMPLIANCE") 
    viostr <- paste0(" ", fontawesome::fa("check-circle", fill = "green"), 
                     paste0(" This water system is **<font color = 'green'>", vio, "</font>**") )
  if(vio == "OUT-OF-COMPLIANCE") 
    viostr <- paste0(" ", fontawesome::fa("exclamation-circle", fill = "red"), 
                     paste0(" This water system is **<font color = 'red'>", vio, "</font>**") )
  if(vio == "RETURNED TO COMPLIANCE") 
    viostr <- paste0(" ", fontawesome::fa("check-circle", fill = "orange"), 
                     paste0(" This water system has **<font color = 'orange'>", vio, "</font>**") )
}
...
To see frequently asked question about this CCR, [visit the FAQ](https://caccr.github.io/faq/).  